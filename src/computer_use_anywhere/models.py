...
ACTION_KINDS = {
    ACTION_LEFT_CLICK, ACTION_RIGHT_CLICK, ACTION_DOUBLE_CLICK, ACTION_MIDDLE_CLICK,
    ACTION_DRAG_START, ACTION_DRAG_MOVE, ACTION_DRAG_END,
    ACTION_SCROLL_UP, ACTION_SCROLL_DOWN,
    ACTION_KEY_PRESS, ACTION_TYPE_TEXT,
    ACTION_MOVE_ONLY,
}
